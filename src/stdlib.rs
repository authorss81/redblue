...
pub fn builtins() -> HashMap<String, Value> {
    ...
    // Files module
    globals.insert("files_read".to_string(), Value::Builtin("files_read".to_string()));
    globals.insert("files_write".to_string(), Value::Builtin("files_write".to_string()));
    globals.insert("files_append".to_string(), Value::Builtin("files_append".to_string()));
    globals.insert("files_exists".to_string(), Value::Builtin("files_exists".to_string()));
    globals.insert("files_lines".to_string(), Value::Builtin("files_lines".to_string()));
    globals.insert("files_delete".to_string(), Value::Builtin("files_delete".to_string()));
    globals.insert("files_copy".to_string(), Value::Builtin("files_copy".to_string()));
    globals.insert("files_rename".to_string(), Value::Builtin("files_rename".to_string()));
    
    // Time module
    globals.insert("time_now".to_string(), Value::Builtin("time_now".to_string()));
    globals.insert("time_sleep".to_string(), Value::Builtin("time_sleep".to_string()));
    globals.insert("time_format".to_string(), Value::Builtin("time_format".to_string()));
    globals.insert("time_unix".to_string(), Value::Builtin("time_unix".to_string()));
    
    // Formats module
    globals.insert("json_parse".to_string(), Value::Builtin("json_parse".to_string()));
    globals.insert("json_stringify".to_string(), Value::Builtin("json_stringify".to_string()));
    globals.insert("csv_parse".to_string(), Value::Builtin("csv_parse".to_string()));
    
    // Network module
    globals.insert("network_get".to_string(), Value::Builtin("network_get".to_string()));
    globals.insert("network_post".to_string(), Value::Builtin("network_post".to_string()));
    ...
    // Console module
    globals.insert("console_log".to_string(), Value::Builtin("console_log".to_string()));
    globals.insert("console_error".to_string(), Value::Builtin("console_error".to_string()));
    globals.insert("console_clear".to_string(), Value::Builtin("console_clear".to_string()));
    
    // Random module
    globals.insert("random_number".to_string(), Value::Builtin("random_number".to_string()));
    globals.insert("random_choice".to_string(), Value::Builtin("random_choice".to_string()));
    globals.insert("random_shuffle".to_string(), Value::Builtin("random_shuffle".to_string()));
